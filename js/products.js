 ...
 * para el Hospital Angeles del Carmen.
 */
const PRODUCTS_DATA = {
  alberca: {
  ...
  ahorro: {
    ...
    slogan: "Sustentabilidad financiera y bioseguridad para el Hospital Angeles del Carmen con sistemas de alta concentración.",
    products: [
      {
        id: "audit_service",
        ...
        phImpact: "No aplica.",
        safety: "Protocolo de visitas bajo las normas de ingreso del Hospital Angeles del Carmen.",
    ...
    products: [
      {
        ...
        usage: "Cocinas, habitaciones, sanitarios o salas de espera del Hospital Angeles del Carmen.",
