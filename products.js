...
const PRODUCTS_DATA = {
  ...
  ahorro: {
    ...
    slogan: "Sustentabilidad financiera y bioseguridad para el Hospital Jardines con sistemas de alta concentración.",
    products: [
      {
        id: "audit_service",
        ...
        phImpact: "No aplica.",
        safety: "Protocolo de visitas bajo las normas de ingreso del Hospital Jardines.",
    ...
    products: [
      {
        ...
        usage: "Cocinas, habitaciones, sanitarios o salas de espera del Hospital Jardines.",
